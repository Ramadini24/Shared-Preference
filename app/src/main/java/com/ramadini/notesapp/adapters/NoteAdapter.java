package com.ramadini.notesapp.adapters;
...
import com.ramadini.notesapp.Constant;
import com.ramadini.notesapp.R;
import com.ramadini.notesapp.Settings;
import com.ramadini.notesapp.models.Note;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> {
    ...
    public class ListViewHolder extends ViewHolder {
        ...
        public ListViewHolder(@NonNull View itemView) {
            ...
            float textSize = Settings.getTextSize(Constant.PREF_TEXT_SIZE, "20");
